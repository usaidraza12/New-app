...
import { TrendingUp, TrendingDown, Users, Package, ShoppingCart, DollarSign, Download } from "lucide-react"
...
const salesData = [
  ...
  { month: "Jun", revenue: 8900, orders: 89 },
]

const topProducts = [
  { name: "Pagani Huayra T-Shirt", sales: 156, revenue: 4680 },
  { name: "Predict Future T-Shirt", sales: 134, revenue: 3346 },
  { name: "Universe Deepspac T-Shirt", sales: 98, revenue: 2744 },
  { name: "Not Okay T-Shirt", sales: 87, revenue: 1998 },
  { name: "Classic Black Tee", sales: 76, revenue: 1520 },
]
              ...
              <tbody>
                {topProducts.map((product, index) => (
                  <tr key={index} className="border-b hover:bg-gray-50">
                    ...
                    <td className="py-4 px-4 font-medium">${product.revenue.toLocaleString()}</td>
                    <td className="py-4 px-4">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm text-gray-600">{Math.round((product.sales / 156) * 100)}%</span>
                      </div>
                    </td>
                  </tr>
                ))}
